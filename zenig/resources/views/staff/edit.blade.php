...
<div class="container">
    ...
    <div class="form-group col-md-3 mb-3">
        ...
        <input type="text" class="form-control" id="user_name" name="user_name" value="{{ $staff->user_name }}" required>
    </div>
    <div class="form-group col-md-3 mb-3">
...
<div class="row">
    ...
    <div class="form-group col-md-3 mb-3">
        ...
        <select class="form-control" id="role" name="role[]" multiple>
            <option value="Admin" {{ in_array('Admin', $staff->roles ?? []) ? 'selected' : '' }}>Admin</option>
            <option value="User" {{ in_array('User', $staff->roles ?? []) ? 'selected' : '' }}>User</option>
        </select>
    </div>
</div>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <select class="form-control select2" id="gender" name="gender" value="{{ $staff->personalData->gender }}" required>
                        ...
                        <option value="Other" {{$staff->personalData->gender == 'Female' ? 'selected' : ''}}>Other</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <label for="marital_status">Marital Status</label>
                    <select class="form-control select2" id="marital_status" name="marital_status" value="{{ $staff->personalData->marital_status }}" required>
        ...
        <div id="crudRows">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control" id="account_type" name="account_type" value="{{ $staff->bankData->account_type }}" required>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <select class="form-control" id="account_status" name="account_status" value="{{ $staff->bankData->account_status }}" required>
                        <option value="">Select Status</option>
